...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002566326238 -1003016600468').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ncmoviesearch ') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ncadminbot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/ncbotsn') # Update channel link for the bot
